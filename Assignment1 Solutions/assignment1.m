...
% Answer: clears all saved variables;
...
%For loops are great for when you have a set number of times you want the
%loop to run, WHILE loops run until a certain condition is met, which may
%be an unknown number at the time.
% 
...
% Answer: Not a Number. Can be displayed when there is an error in the
% code, or when the value cannot be represented by numbers, such as if
% there are letters involved in the answer, or theoretical numbers.
